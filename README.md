...
I need to examine the codebase to understand the Alertify package structure and functionality before creating documentation files.
...
filePath: /Volumes/Amjad/Personal/Freelancer/Personal Stuff/Laravel Packages/alrti/README.md
          
I need to check the composer.json file to understand the package configuration and dependencies.
...
filePath: /Volumes/Amjad/Personal/Freelancer/Personal Stuff/Laravel Packages/alrti/composer.json
          
I need to examine the service provider to understand how the package integrates with Laravel.
...
filePath: /Volumes/Amjad/Personal/Freelancer/Personal Stuff/Laravel Packages/alrti/src/Providers/AlertifyServiceProvider.php
          
I need to check the helper functions to understand how users interact with the package.
...
filePath: /Volumes/Amjad/Personal/Freelancer/Personal Stuff/Laravel Packages/alrti/src/Helpers/functions.php
          
I need to examine the Notifier class to understand the core functionality of the package.
...
filePath: /Volumes/Amjad/Personal/Freelancer/Personal Stuff/Laravel Packages/alrti/src/Core/Notifier.php
          
I need to check the alert.blade.php file to understand how the alerts are rendered in the views.
...
filePath: /Volumes/Amjad/Personal/Freelancer/Personal Stuff/Laravel Packages/alrti/src/Views/alert.blade.php
          
I need to check the AlertSessionStore class to understand how the session handling works.
...
filePath: /Volumes/Amjad/Personal/Freelancer/Personal Stuff/Laravel Packages/alrti/src/Storage/AlertSessionStore.php
          
I need to check the SessionStore interface to understand the contract for session storage.
...
filePath: /Volumes/Amjad/Personal/Freelancer/Personal Stuff/Laravel Packages/alrti/src/Storage/SessionStore.php
